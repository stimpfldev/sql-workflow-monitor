...
This repository supports technical evaluation and verifiable product presentation. GitHub issues may be used for:
...
5. Remove all credentials, customer data, production names, private licenses, and sensitive logs from the report.
...
Public repository support does not include:

- guaranteed response times;
- production incident response;
- customer-specific deployment or migration work;
- private license generation;
- Professional or Enterprise support obligations;
- custom development without a separate agreement.

## Commercial inquiries

For Demo evaluation, Professional or Enterprise licensing, onboarding, installation, integration, support, or customization:

- Website: `https://www.federicostimpfl.com.ar`
- Email: `federicosdev@gmail.com`
- LinkedIn: `https://www.linkedin.com/in/federicosdev`

Related professional services include .NET backend development, SQL Server and stored procedures, REST APIs, Worker Services, batch/data workflows, integrations, modernization, operational reliability, and SqlWorkflowMonitor customization.
