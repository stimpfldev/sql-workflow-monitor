...
4. **Private licensing toolchain** — license creation and signing remain outside the public repository. The public application contains only verification components and a public key.
...
- Private signing keys and customer licenses are never part of the public repository.
